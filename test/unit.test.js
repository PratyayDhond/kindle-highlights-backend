...
describe('Unit Tests', () => {
  ...
  describe('checkForNewHighlights', () => {
  ...
  describe('cleanEmail', () => {
    ...
    it('returns email in lowercase domain', () => {
      expect(cleanEmail('test@TEST.COM')).toBe('test@test.com');
    });

    it('handles multiple plus signs correctly', () => {
      expect(cleanEmail('test+alias+extra@gmail.com')).toBe('test@gmail.com');
    });

    it('handles edge cases gracefully', () => {
      expect(cleanEmail('test@test@test.com')).toBe(null); 
      expect(cleanEmail('invalidEmail')).toBe(null); 
      expect(cleanEmail('')).toBe(null);
